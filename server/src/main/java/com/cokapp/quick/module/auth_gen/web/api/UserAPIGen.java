...
public abstract class UserAPIGen extends BaseController<User, Long> {
	...
	@ResponseBody
	public JsonResult<User> delete(@PathVariable("id") Long id) {
		this.getService().delete(id);
		return JsonResult.<User> newSuccess("删除成功！");
	}
	...
	@ResponseBody
	public JsonResult<User> list(HttpServletRequest request,
	...
	@ResponseBody
	public JsonResult<User> update(@RequestBody User entity, @PathVariable("id") Long id) {
		entity.setId(id);
	...
	@ResponseBody
	public JsonResult<User> view(@PathVariable("id") Long id) {
		User entity = this.getService().findOne(id);
		if (entity == null) {
